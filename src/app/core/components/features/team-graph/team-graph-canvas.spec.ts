 ...
 *
 * `team-graph.component.spec.ts` covers the OVERLAY: the DOM that sits on top. This
 ...
 * `<app-team-graph>` as its own root silently deletes it — a fixture root is checked
...
describe('the hierarchy canvas', () => {
  ...
  function graph(): TeamGraphComponent {
    return fixture.debugElement.query(
      (found) => found.componentInstance instanceof TeamGraphComponent,
