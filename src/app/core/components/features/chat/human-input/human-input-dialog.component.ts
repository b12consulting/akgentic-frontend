...
@Component({
  selector: 'app-human-input-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './human-input-dialog.component.html',
  styleUrl: './human-input-dialog.component.scss',
})
export class HumanInputDialogComponent {
