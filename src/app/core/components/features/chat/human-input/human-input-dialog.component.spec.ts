...
import {
  AnsweredRequest,
  HumanInputDialogComponent,
  HumanModalReply,
} from './human-input-dialog.component';
...
describe('HumanInputDialogComponent', () => {
  let component: HumanInputDialogComponent;
  let fixture: ComponentFixture<HumanInputDialogComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [HumanInputDialogComponent, NoopAnimationsModule],
      providers: [provideMarkdown(), provideTranslateTesting()],
    }).compileComponents();

    fixture = TestBed.createComponent(HumanInputDialogComponent);
