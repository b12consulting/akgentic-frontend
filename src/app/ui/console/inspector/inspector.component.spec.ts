...
describe('InspectorComponent', () => {
  ...
  function inspectorEl(): HTMLElement {
    return fixture.debugElement.query(By.css('app-inspector'))
  ...
  describe('(W17) the narrow-pane message', () => {
    function inspector(): InspectorComponent {
      return fixture.debugElement.query(By.directive(InspectorComponent))
        .componentInstance as InspectorComponent;
    }
